...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#fff] shadow-[4px_2px_20px_4px_rgba(0,0,0,0.1)] dark:bg-[#1c1c24] cursor-pointer transform transition duration-500 hover:scale-105 animate-[fade-in_1s_ease-in-out]" onClick={handleClick}>
